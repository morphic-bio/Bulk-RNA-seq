...
class OWdownloadURL(OWBwBWidget):
    ...
    docker_image_tag = "alpine-3.15__da0b8b3c__570359bc__4ed7eaa4"
    inputs = [("directory",str,"handleInputsdirectory"),("trigger",str,"handleInputstrigger"),("URL",str,"handleInputsURL"),("skipDownload",str,"handleInputsskipDownload")]
    ...
    def handleInputsURL(self, value, *args):
        if args and len(args) > 0: 
            ...
            self.handleInputs("inputFile", value, None, False)
    def handleInputsskipDownload(self, value, *args):
        if args and len(args) > 0: 
            self.handleInputs("skipDownload", value, args[0][0], test=args[0][3])
        else:
            self.handleInputs("inputFile", value, None, False)
