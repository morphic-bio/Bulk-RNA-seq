...
class OWstarAlign(OWBwBWidget):
    ...
    inputs = [("outputDir",str,"handleInputsoutputDir"),("genomeDir",str,"handleInputsgenomeDir"),("starversion",str,"handleInputsstarversion"),("readFilesIn",str,"handleInputsreadFilesIn"),("download_trigger",str,"handleInputsdownload_trigger"),("trim_trigger",str,"handleInputstrim_trigger")]
