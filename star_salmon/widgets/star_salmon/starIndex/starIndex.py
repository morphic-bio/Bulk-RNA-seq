...
class OWstarIndex(OWBwBWidget):
    ...
    inputs = [("Trigger",str,"handleInputsTrigger"),("starversion",str,"handleInputsstarversion"),("genimedir",str,"handleInputsgenimedir")]
    ...
    def handleInputsstarversion(self, value, *args):
        if args and len(args) > 0: 
            ...
            self.handleInputs("inputFile", value, None, False)
    def handleInputsgenimedir(self, value, *args):
        if args and len(args) > 0: 
            self.handleInputs("genimedir", value, args[0][0], test=args[0][3])
        else:
            self.handleInputs("inputFile", value, None, False)
